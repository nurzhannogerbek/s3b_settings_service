...
func handleRequest(e common.Event) (interface{}, error) {
	var organizationEvent common.OrganizationDepartmentCreateInput
	if err := json.Unmarshal(e.Arguments, &organizationEvent); err != nil {
		return nil, err
	}

	organizationDepartment, err := Services.Organization.CreateOrganizationDepartment(&organizationEvent)
	if err != nil {
		return nil, err
	}
